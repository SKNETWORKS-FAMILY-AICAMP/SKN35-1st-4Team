"""
불법주정차 단속 위치정보(25년1월1일_25년3월31일).csv 에서 종로구 데이터만 뽑아 정제하는 스크립트.
...
실행
    python3 dataset_jongno_location.py
# """
...
INPUT_FILE = 불법주정차 단속 위치정보(25년1월1일_25년3월31일).csv"
OUTPUT_FILE = "종로구_주정차단속위치_정제.csv"
